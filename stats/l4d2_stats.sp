...
/*
    ...
    ----
        ...
        - tongue cut incorrectly detected if somebody else kills smoker
        - add: count shoving-free from smoker as self-clearing too
        - got a chip-level that counted as a full-level
